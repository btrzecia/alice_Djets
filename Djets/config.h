...
enum DMesonSpecies {kD0toKpi=0, kDStarD0pi};
    ...
    TString       fSystemS = "0-20% Pb-Pb, #sqrt{#it{s}_{NN}} = 5.02 TeV";
    ...
    const int     Rpar = 3;
    const int     ND = 5;                //-----!  change these numbers based on how many D mesons you analyse in data !
    ...
    const int     fptbinsJetMeasN = 13;
    double        fptbinsJetMeasA[fptbinsJetMeasN+1] = { -20,-10,-5,0,3,5,6,8,10,14,20,30,50,70 };
    ...
    Float_t       fsigmaBkg[] = {-9,-4,4,15};         //-----! sigma for the SB region (both left and right side from the fit)
...
TString OUTDIRECTORY="/home/basia/Work/ALICE/Analysis/Results/PbPb2015/D0jets/results/DzeroR03_Antonio_StdCuts";

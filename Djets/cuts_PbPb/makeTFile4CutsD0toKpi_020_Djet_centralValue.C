  ...
  //setting my cut values
    ...
    //     printf("    NormDecayLenghtXY    > %f\n",fD0toKpiCuts[10]);
	    ...
	    Float_t cutsMatrixD0toKpiStand[nptbins][nvars] = {
			...
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.83, 0.999, 5 }, /* 12<pt<14*/
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.83, 0.999, 5 }, /* 14<pt<16*/
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.82, 0.999, 5 }, /* 16<pt<18*/
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.82, 0.999, 5 }, /* 18<pt<20*/
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.82, 0.999, 5 }, /* 20<pt<24*/
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.82, 0.999, 5 }, /* 24<pt<36*/
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.82, 0.999, 5 }, /* 36<pt<50*/	
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.82, 0.999, 5 } /* pt>50*/	
		...
		Float_t cutsMatrixD0toKpiAntonio[nptbins][nvars] = {
			...
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.82, 0.999, 6 } /* pt>50*/	
						   ...
						   {{0.400,400.*1E-4,0.6,0.5,0.5,1000.*1E-4,1000.*1E-4,varyd0xd0[0][vcd0xd0],varyCosPoint[0][vccospoint],0.99,7.},/* 0<pt<0.5*/
    ...
    Float_t d0MeasMinusExpCut[32]={1.,/* 0<pt<0.5*/
					1.,/* 0.5<pt<1*/
					1.,/* 1<pt<1.5*/
					1.,/* 1.5<pt<2*/
					1.,/*2<pt<2.25*/
...
//  RDHFD0toKpi->SetMaxDifferenceTRKV0Centraltity(5.);
  ...
  TFile* fout=new TFile("D0toKpiCuts_PbPb2015_0_20_Djet_setA.root","recreate");   //set this!!

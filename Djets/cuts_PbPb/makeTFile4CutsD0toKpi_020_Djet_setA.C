  ...
  //setting my cut values
    ...
    //     printf("    NormDecayLenghtXY    > %f\n",fD0toKpiCuts[10]);
	    ...
	    Float_t cutsMatrixD0toKpiStand[nptbins][nvars] = {
			...
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1, -3.00*1E-6, 0.8, 0.999, 5 }, /* 20<pt<24*/
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1,  0.00*1E-6, 0.8, 0.999, 5 }, /* 24<pt<36*/
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1,  0.00*1E-6, 0.8, 0.999, 5 }, /* 36<pt<50*/	
			{ 0.400, 400.*1E-4, 1.0, 0.7, 0.7, 0.1, 0.1,  0.00*1E-6, 0.8, 0.999, 5 } /* pt>50*/	
